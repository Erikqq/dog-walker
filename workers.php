...
$workerQuery = "SELECT id, username, email, description FROM users WHERE wants_to_be_walker = 1";
...
if (isset($_GET['targetUserId']) && isset($_GET['adminLevel'])) {
    ...
    if (mysqli_num_rows($userResult) == 1) {
        $updateAdminQuery = "UPDATE users SET adminlevel = '$adminLevel', wants_to_be_walker = 0 WHERE id = '$targetUserId'";
...
<div class="navbar">
    ...
    <?php if ($isAdmin2): ?>
        ...
        <a class="nav-link">Munkások kezelése</a><?php endif; ?>
